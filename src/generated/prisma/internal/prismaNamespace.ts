...
> = {
	...
	meta: {
		modelProps: 'usuario' | 'categoria' | 'produto' | 'movimentacaoEstoque';
		...
		Produto: {
			...
			operations: {
				...
				count: {
					...
					result:
						| runtime.Types.Utils.Optional<Prisma.ProdutoCountAggregateOutputType>
						| number;
				};
			};
		};
		MovimentacaoEstoque: {
			...
			operations: {
				...
				count: {
					...
					result:
						| runtime.Types.Utils.Optional<Prisma.MovimentacaoEstoqueCountAggregateOutputType>
						| number;
				};
			};
		};
